...
class porfiles_Serializer(serializers.ModelSerializer):
	class Meta:
		model = profiles
		fields = ('id','user','biography','num_of_subscribers','num_of_subscriptions','num_of_posts')


class subscriptions_Serializer(serializers.ModelSerializer):
	class Meta:
		model = subscriptions
		fields = ('id','subscriber_user','subscribed_to_user','subscribed_since')
...
class UserSerializer(serializers.ModelSerializer):
	...
	class Meta:
		model = User
		fields = ['id','email','username','password','password2','profile']
