...
class profiles(models.Model):
	user = models.ForeignKey(User, related_name = "profile_owner" ,on_delete=models.CASCADE,blank = True)
	...
	def num_of_subscribers(self):
		subs = subscriptions.objects.filter(subscribed_to_user = self.user).count()
		return subs
...
class subscriptions(models.Model):
	subscriber_user = models.ForeignKey(User, related_name = "subscriber" ,on_delete=models.CASCADE,blank = True)
	subscribed_to_user = models.ForeignKey(User, related_name = "subscibed_to" ,on_delete=models.CASCADE,blank = True)
